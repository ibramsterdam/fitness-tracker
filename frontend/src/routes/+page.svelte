<script>
    ...
    async function userSession() {
        ...
        if (nullOrUndefined(access_token)) {
            ...
            document.querySelector("#sign_up_here").style.display = "block";
            document.querySelector("#sign_in_here").style.display = "block";
            ...
            document.querySelector("#sign_up_here").style.display = "none";
            document.querySelector("#sign_in_here").style.display = "none";
    ...
    async function userCanAccess() {
        ...
        const response = await fetch(`http://localhost:3000/examples/restricted`, {
            method: "GET",
            headers: {
            "Content-Type": "application/json",
